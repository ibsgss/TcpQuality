    ...
    nix --extra-experimental-features 'nix-command flakes' \
      ...
      --command bash -c '
        exec sudo env \
          ...
          "TCPQUALITY_IPQUALITY_MAXMIND_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_MAXMIND_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_MAXMIND_RISK_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_MAXMIND_RISK_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_IP2LOCATION_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_IP2LOCATION_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_IPINFO_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_IPINFO_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_SCAMALYTICS_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_SCAMALYTICS_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_ACTIVE_NEIGHBOR_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_ACTIVE_NEIGHBOR_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_IPAPI_CACHE_TTL_SECONDS=${TCPQUALITY_IPQUALITY_IPAPI_CACHE_TTL_SECONDS:-}" \
          "TCPQUALITY_IPQUALITY_IPAPI_CACHE_DIR=${TCPQUALITY_IPQUALITY_IPAPI_CACHE_DIR:-}" \
          "TCPQUALITY_MAXMIND_RISK_IPV6_PREFIX=${TCPQUALITY_MAXMIND_RISK_IPV6_PREFIX:-}" \

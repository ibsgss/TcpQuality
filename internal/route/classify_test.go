...
func TestClassify(t *testing.T) {
	cases := []struct {
		...
		// CMIN2 outranks a CMI hop appearing earlier in the trace.
		{"CMIN2 over CMI", []string{"223.120.1.1", "2402:4f00:f000::1"}, nil, "1.2.3.4", "移动", "CMIN2"},
		// Unicom routes transiting China Mobile are labelled with both legs.
		{"CMIN2->4837", []string{"2402:4f00:f000::1", "219.158.1.1"}, nil, "1.2.3.4", "联通", "CMIN2->4837"},
		{"CMI->4837", []string{"223.120.1.1", "219.158.1.1"}, nil, "1.2.3.4", "联通", "CMI->4837"},
		// A three-leg label collapses to its first and last legs.
		{"combo compacted", []string{"2402:4f00:f000::1", "223.120.1.1", "219.158.1.1"}, nil, "1.2.3.4", "联通", "CMIN2->4837"},
		{"163->4837", []string{"202.97.1.1", "219.158.1.1"}, nil, "1.2.3.4", "联通", "163->4837"},
		// A Unicom access ASN counts as the first Unicom hop.
		{"unicom access asn", []string{"202.97.1.1", "8.8.8.8", "219.158.1.1"},
			map[string]string{"8.8.8.8": "17816"}, "1.2.3.4", "联通", "163->4837"},
	}

...
func inferASNFromIP(ip string) string {
	...
	case strings.HasPrefix(ip, "2402:4f00:f000:"):
		return "58807"
	case strings.HasPrefix(ip, "2409:8080:"):
		return "9808"
...
func isCMIN2ASN(asn string) bool { return asn == "58807" }

func isCMIASN(asn string) bool {
	return asn == "58453" || asn == "9808" || reCMI5604x.MatchString(asn)
}
